...
for sor in lista:
  if sor.datum > utolso:
    utolso = sor.datum
    utolso_sor = sor
print(f"7. feladat: A legutoljára csatlakozott orszag: {utolso_sor.orszag}")
"""
utolso_orszag = max(lista, key=lambda x:x.datum).orszag
print(f"7. feladat: A legutoljára csatlakozott orszag: {utolso_orszag}")
